...
- **Plan a mid-project review** with the partner after your research sprint to communicate progress, initial observations, and update the project brief as needed. If you've been meeting weekly, this may be a short check-in (1-2 hours), but it's helpful to take stock and make sure you're still aligned on the focus and goals. As you create presentations and begin to share ideas, follow [presentation best practices](https://docs.google.com/document/d/1SwWADPsr_rDlHRaga7mFwY-F4vvrU8dfcmL9Sbbd364/edit) to ensure you're being concise and compelling.
