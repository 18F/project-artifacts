...
Start thinking about your recommendations and core findings as early as possible; these will become the meat of your final report. It's a good idea to find out whether the client agrees with your findings before you start working with them on recommendations. If not, figure out why. Is there some context you're missing? Is the way you're articulating the finding not resonating? You may need to better understand the situation or better explain the finding. If you have a finding the client acknowledges but that isn't a priority for them, it's probably better for you to spend your time on recommendations for findings they do care about. Work with the partner to come up with recommendations that will work given the agency’s resources, culture, and priorities.

Start writing (or preparing to write) at about the midpoint of your path analysis. Writing always takes longer than you'd think, and getting started on writing the stuff that doesn't depend on finishing your analysis — like the problem statement, background, etc. — can help overcome the inertia of a blank page. 

The [PA report template](https://docs.google.com/document/d/1DBgwnnHuvR2fAojOwjP8gZ3_jA9pEAGRRKOnmH69d0s/edit?pli=1) includes several elements: a problem statement (what problem we're trying to solve), background (what's the current state), findings (what you observed), recommendations (how to move forward and address the findings), and next steps (what needs to happen first and how 18F might be involved).
